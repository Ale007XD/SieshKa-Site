...
from sqlalchemy import String, Integer, Boolean, DateTime, Text, Enum, Time, ARRAY, func
from sqlalchemy.orm import Mapped, mapped_column
from .db import Base
from .timefirst_core import Daypart, DeliveryMethod
...
class AvailabilityRule(Base):
    ...
    scope_type: Mapped[AvailabilityScopeType] = mapped_column(
        Enum(AvailabilityScopeType), nullable=False, index=True
    )
    ...
    daypart: Mapped[Daypart] = mapped_column(
        Enum(Daypart), default=Daypart.ALLDAY, nullable=False
    )
